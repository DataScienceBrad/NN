                ...
                if (data.dataPoints.length) {
                    ...
                    if(textElement.length){
                        for(var i = 0; i < textElement.length ; i++){
                            TextMeasurementService.wordBreak(textElement[i][0], this.maxLegendTextLength, 60);
            ...
            private createLabelDataPoints(): LabelDataPointGMO[] {
                ...
                for (var currentSeriesIndex in series) {
                    ...
                    for (var dataPointIndex in currentSeries.data) {
                        ...
                        var parentRect: powerbi.extensibility.utils.svg.Rect = {
        ...
        */
        ...
        export class StackedChartGMO implements IVisual {
            ...
            private renderLegend(): void {
                ...
                if (legendProperties) {
                    powerbi.extensibility.utils.chart.legend.data.update(legendData, legendProperties);
    ...
    public applyUserMinMax(isScalar: boolean, dataView: DataViewCategorical, xAxisCardProperties: DataViewObject): DataViewCategorical {
            ...
            public converter(
                ...
                var defaultLegendLabelColor = powerbi.extensibility.utils.chart.legend.data.DefaultLegendLabelFillColor;
                ...
                if (dataViewMetadata && dataViewMetadata.objects) {
                    ...
                    defaultLegendLabelColor = DataViewObjects.getFillColor(objects, columnChartProps.legend.labelColor, powerbi.extensibility.utils.chart.legend.data.DefaultLegendLabelFillColor);
            ...
            private getLegendValue(enumeration: ObjectEnumerationBuilder): void {
                ...
                var legendLabelColor = DataViewObject.getValue<string>(this.legendObjectProperties, legendProps.labelColor, powerbi.extensibility.utils.chart.legend.data.DefaultLegendLabelFillColor);
            ...
            public render(suppressAnimations: boolean, resize: boolean): CartesianVisualRenderResultGMO {
                ...
                if(totalLabelSettings.show){
                    ...
                    var totalTitleText = TextMeasurementService.getTailoredTextOrDefault(totalTitleTextProperties, maxLabelTextWidth);
                ...
                if(this.dataViews[1] && this.dataViews[1].categorical && this.dataViews[1].categorical.values){
                    ...
                    var secMeasuretext = TextMeasurementService.getTailoredTextOrDefault(secMeasuretextProperties, maxLabelTextWidth);    
                    this.root.select('.cartesianChart')
                        .append('text')
                        .attr('x',1)
                        .attr('y',yAxisForLabels - numberOfMeasures + (yAxisMultiplier * --measureCounter))
                ...
                if(this.dataViews[3] && this.dataViews[3].categorical && this.dataViews[3].categorical.values){
                    ...
                    var terMeasuretext = TextMeasurementService.getTailoredTextOrDefault(terMeasuretextProperties, maxLabelTextWidth);    
                    this.root.select('.cartesianChart')
                        .append('text')
                        .attr('x',1)
                        .attr('y',yAxisForLabels - numberOfMeasures + (yAxisMultiplier * --measureCounter))
                ...
                if(this.dataViews[4] && this.dataViews[4].categorical && this.dataViews[4].categorical.values){
                    ...
                    var quatMeasuretext = TextMeasurementService.getTailoredTextOrDefault(quatMeasuretextProperties, maxLabelTextWidth);
                    this.root.select('.cartesianChart')
                        .append('text')
                        .attr('x',1)
                        .attr('y',yAxisForLabels - numberOfMeasures + (yAxisMultiplier * --measureCounter))
                ...
                while(len >= 0){
                    ...
                    if(totalLabelSettings.show){
                        ...
                        var totalText = TextMeasurementService.getTailoredTextOrDefault(DatatextProperties,barWidthValue);
                    ...
                    if(this.dataViews[1] && this.dataViews[1].categorical && this.dataViews[1].categorical.values){
                        ...
                        var secText = TextMeasurementService.getTailoredTextOrDefault(secDatatextProperties,barWidthValue);
                        this.root.select('.svgScrollable > .axisGraphicsContext')
                            .append('text')
                    ...
                    if(this.dataViews[3] && this.dataViews[3].categorical && this.dataViews[3].categorical.values){
                        ...
                        var terText = TextMeasurementService.getTailoredTextOrDefault(terDatatextProperties,barWidthValue);
                        this.root.select('.svgScrollable > .axisGraphicsContext')
                            .append('text')
                    ...
                    if(this.dataViews[4] && this.dataViews[4].categorical && this.dataViews[4].categorical.values){
                        ...
                        var quatText = TextMeasurementService.getTailoredTextOrDefault(quatDatatextProperties,barWidthValue);
                        this.root.select('.svgScrollable > .axisGraphicsContext')
                            .append('text')
