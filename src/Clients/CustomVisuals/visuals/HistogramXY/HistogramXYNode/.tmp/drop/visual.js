 ...
 */
/*JSHint Count = 0*/
function MAQDrawChart(DataStyle, settings) {
    //data binding
    var dataView = DataStyle;
    var availWidth;
    var dataViewObject = Object.getPrototypeOf(dataView);
    var identifierX = 0, identifierY = 1;
    if (0 !== DataStyle.metadata.columns.length && DataStyle.metadata.columns[0].roles.hasOwnProperty('yAxis')) {
        identifierX = 1;
        identifierY = 0;
    }
    //format options
    ...
    var xAxisName = dataView.metadata.columns[0].displayName, yAxisName = dataView.metadata.columns[1].displayName;
    if (dataView.metadata.columns[0].roles.yAxis === true) {
        xAxisName = dataView.metadata.columns[1].displayName;
        yAxisName = dataView.metadata.columns[0].displayName;
    }
    //grid lines
    ...
    (function (config) {
                    ...
                    switch (sChartType.toLowerCase()) {
                        case 'histogram':
                            if (oParam.category == "histogram") {
                                oToolTip.innerHTML = '<b>' + (oConfig.xAxis.title.enabled ? oConfig.xAxis.title.text : xAxisName) + ': </b>' + (Math.round(oSeries.data.scaleX[iSelectedIndex] * 100) / 100 || '-') + '<br/><b>' + (oConfig.yAxis.dualyAxis.axisRight.title.enabled ? oConfig.yAxis.dualyAxis.axisRight.title.text : yAxisName) + ': </b>' + (Math.round(oSeries.data.scaleY[iSelectedIndex] * 100) / 100 || '-');
                            }
        ...
        */
        MAQ.drawSecondaryYAxis = function (chartConfigOptions) {
            ...
            //chartConfigOptions.availWidth = chartConfigOptions.availWidth - leftSpacing;
            /* Plot Y-Axis, Y-Axis-Ticks, Y-Axis-GridLines and Y-Axis-Labels */
            oAttr = { class: 'MAQCharts-yAxis-gridArea' };
        ...
        MAQ.createHistogramChart = function (chartConfigOptions) {
            ...
            //For frequency data
            for (iCounter = 0; iCounter < oNormalizedDataXAxis.interval; iCounter++) {
                chartConfigOptions.series[iSeriesCounter].data.frequency.data[iCounter] = 0;
            }
            for (iCounter = 0; iCounter < oNormalizedDataXAxis.interval; iCounter++) {
                chartConfigOptions.series[iSeriesCounter].data.frequency.data[Math.floor(chartConfigOptions.series[iSeriesCounter].data.scaleX[iCounter] / oNormalizedDataXAxis.interval)]++;
            }
            var oDataInfo = {
                min: 0,
                max: 1
...
(function (powerbi) {
    ...
    (function (extensibility) {
        var visual;
        (function (visual) {
            var PBI_CV_309E6B47_39A5_4681_808F_132AFB230871;
            (function (PBI_CV_309E6B47_39A5_4681_808F_132AFB230871) {
                var Visual = (function () {
                    function Visual(options) {
                        ...
                        this.viewport;
                        var svg = this.svg = d3.select(options.element).append('div').classed('container', true);
                    ...
                    Visual.prototype.update = function (options) {
                        ...
                        if (options.dataViews && options.dataViews.length > 0) {
                            ...
                            if (!this.histogram || settingsChanged || ((options.type & powerbi.VisualUpdateType.Resize) || options.type & powerbi.VisualUpdateType.ResizeEnd)) {
                                this.svg.selectAll("*").remove();
                                this.histogram = MAQDrawChart(dataView, this.settings);
                            }
                        }
                    };
                    /**
                    ...
                    Visual.prototype.getSettings = function (objects) {
                        ...
                        if (typeof this.settings == 'undefined' || (JSON.stringify(objects) !== JSON.stringify(this.prevDataViewObjects))) {
                            this.settings = {
                                showPoints: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'points', 'show', true),
                                showBars: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'bars', 'show', true),
                                //title
                                showxAxisTitle: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'xAxis', 'titleEnable', true),
                                showyAxisLeftTitle: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'yAxisLeft', 'titleEnable', true),
                                showyAxisRightTitle: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'yAxisRight', 'titleEnable', true),
                                //label
                                showxAxisLabel: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'xAxis', 'label', true),
                                showyAxisLeftLabel: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'yAxisLeft', 'label', true),
                                showyAxisRightLabel: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'yAxisRight', 'label', true),
                                //grid lines
                                showGridLines: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'gridLines', 'show', true),
                                //point bar
                                pointTooltip: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'points', 'pointTooltip', true),
                                pointColor: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'points', 'pointColor', { solid: { color: "#3261BA" } }).solid.color,
                                barTooltip: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'bars', 'barTooltip', true),
                                barColor: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'bars', 'barColor', { solid: { color: "#008000" } }).solid.color,
                                //title
                                xTitleText: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'xAxis', 'titleText', "X"),
                                yTitleTextLeft: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'yAxisLeft', 'titleText', "Histogram count"),
                                yTitleTextRight: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'yAxisRight', 'titleText', "Y"),
                                //label
                                //grid lines
                                showxAxisGridLines: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'gridLines', 'xAxis', true),
                                showyAxisGridLines: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'gridLines', 'yAxis', true)
                            };
                ...
                PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.Visual = Visual;
                ...
                PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.logExceptions = logExceptions;
            })(PBI_CV_309E6B47_39A5_4681_808F_132AFB230871 = visual.PBI_CV_309E6B47_39A5_4681_808F_132AFB230871 || (visual.PBI_CV_309E6B47_39A5_4681_808F_132AFB230871 = {}));
    ...
    (function (extensibility) {
        ...
        (function (visual) {
            ...
            (function (PBI_CV_309E6B47_39A5_4681_808F_132AFB230871) {
                ...
                PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue = getValue;
                /**
                ...
                PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getCategoricalObjectValue = getCategoricalObjectValue;
            })(PBI_CV_309E6B47_39A5_4681_808F_132AFB230871 = visual.PBI_CV_309E6B47_39A5_4681_808F_132AFB230871 || (visual.PBI_CV_309E6B47_39A5_4681_808F_132AFB230871 = {}));
        })(visual = extensibility.visual || (extensibility.visual = {}));
    })(extensibility = powerbi.extensibility || (powerbi.extensibility = {}));
})(powerbi || (powerbi = {}));
...
(function (powerbi) {
    ...
    (function (visuals) {
        var plugins;
        (function (plugins) {
            plugins.PBI_CV_309E6B47_39A5_4681_808F_132AFB230871 = {
                name: 'PBI_CV_309E6B47_39A5_4681_808F_132AFB230871',
                displayName: 'HistogramXY',
                class: 'Visual',
                version: '1.0.0',
                apiVersion: '1.1.0',
                create: function (options) { return new powerbi.extensibility.visual.PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.Visual(options); },
                custom: true
            };
