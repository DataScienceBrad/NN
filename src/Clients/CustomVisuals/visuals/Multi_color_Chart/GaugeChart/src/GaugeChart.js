                ...
                "gauge": {
                    ...
                    "dataLabels": {
                        ...
                        "ValueStyle": {
                            ...
                            "formatter": "",
                            "targetLineColor": "#fff",
                            "pointerColor": configChange.TargetColor,//"#333"
                        },
                        "ActualValueStyle": {
                            "color": "#333333",
                            "fontSize": "0",
    ...
    (function (config) {
        ...
        */
        ...
        MAQ.createGaugeChart = function (chartConfigOptions) {
            ...
            var iCounter = 0, iLength = chartConfigOptions.plotOptions.gauge.gaugevaluesAngle.length, posX = [], posY = [],
                fAvailHeight = chartConfigOptions.availHeight,
                fAvailWidth = chartConfigOptions.availWidth,
                fCenterX = fAvailWidth / 2, fCenterY = fAvailHeight / 1.2,
                oGaugePlotOptions = config.plotOptions.gauge;
            ...
            var fInnerRadius = fRadius - oGaugePlotOptions.gaugeWidth,
                ...
                reflectNewY = 0,
                reflectStartY = 0,
                largeFlag = 0, xPos = 0, yPos = 0, idistanceFactor = 8, degreeSeries = [], oGaugeDataGroup, oPath, oParam, oToolTip,
                oAttr = {
