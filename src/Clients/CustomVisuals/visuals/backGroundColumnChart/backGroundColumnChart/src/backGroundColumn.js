/*JSHint Count = 0*/
function myMAQlibrary(dWagon, modeling, liftFormatters) {
            ...
            "column": {
                ...
                "valueBox": {
                    ...
                    "style": {
                        ...
                        "fontSize": liftFormatters.yAXisDataLabels,
                        "fontFamily": "Segoe UI"
                    }
                }
            }
    ...
    for (var j = 0; j < dWagon.categorical.categories[0].values.length; j++) {
        backGroundConfig.xAxis.labels.series[j] = dWagon.tree.root.children[j].name;
        backGroundConfig.series[0].data[j] = dWagon.tree.root.children[j].value;
    }
    if (0 === dWagon.metadata.columns[1].displayName.length)
        return;
            ...
            if (!oParam.type) {
                ...
                if (sToolTipFunctionName) {
                    ...
                    switch (sChartType.toLowerCase()) {
                        default: oToolTip.innerHTML = '<b>' + oSeries.name + '</b><br/>' + oLabels[iSelectedIndex] + ': ' + MAQ.utils.formatters.insertCommas(Math.round(oSeries.data[iSelectedIndex] * 100) / 100 || 0);
                            break;
                    }
                }
            } else {
