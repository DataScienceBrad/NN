    ...
    (function (extensibility) {
        ...
        (function (visual) {
            ...
            (function (PBI_CV_309E6B47_39A5_4681_808F_132AFB230871) {
                ...
                PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.createColorPalette = createColorPalette;
 ...
 */
/*JSHint Count = 0*/
function MAQDrawChart(DataStyle, settings, nodeData, series, assignData) {
    //data binding
    ...
    (function (config) {
        ...
        */
        MAQ.drawAxis = function (chartConfigOptions) {
            ...
            //drawgridlineY
            var finalY;
            if (settings.quadrantDivisionY > yAxisSeries[yAxisSeriesLength] || settings.quadrantDivisionY < yAxisSeries[0]) {
            ...
            //drawgridlineX
            var finalX;
            if (settings.quadrantDivisionX > xAxisSeries[(xAxisSeries.length - 1)] || settings.quadrantDivisionX < xAxisSeries[0]) {
            ...
            while (i < 4) {
                ...
                var title = document.createElementNS(chartConfigOptions.svgNS, "title");
        ...
        (function (visual) {
            ...
            (function (PBI_CV_309E6B47_39A5_4681_808F_132AFB230871) {
                ...
                function visualTransform(options, host) {
                    ...
                    var QuadrantChartDataPoints = [];
                    var dataMax;
                    var colorPalette = PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.createColorPalette(host.colors).reset();
                    var objects = options.dataViews[0];
                    for (var iIterator = 0; iIterator < series.length; iIterator++) {
                        var defaultColor = {
                            solid: {
                        ...
                        QuadrantChartDataPoints.push({
                            ...
                            color: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getCategoricalObjectValue(category, iIterator, 'legendColors', 'legendColor', defaultColor).solid.color,
                ...
                var QuadrantChart = (function () {
                    function QuadrantChart(options) {
                    ...
                    QuadrantChart.prototype.update = function (options) {
                        ...
                        if (options.dataViews && options.dataViews[0]) {
                            ...
                            if (!this.bubbleChartWithAxis || settingsChanged || ((options.type & powerbi.VisualUpdateType.Resize) || options.type & powerbi.VisualUpdateType.ResizeEnd)) {
                     ...
                     */
                    QuadrantChart.prototype.enumerateObjectInstances = function (options) {
                        var objectName = options.objectName;
                        var objectEnumeration = [];
                        switch (objectName) {
                            case "legendColors":
                                for (var _i = 0, _a = this.quadrantChartPoints; _i < _a.length; _i++) {
                                    var QuadrantChartPoint = _a[_i];
                    ...
                    QuadrantChart.prototype.destroy = function () {
                    };
                    QuadrantChart.prototype.getSettings = function (objects) {
                        var settingsChanged = false;
                        if (typeof this.settings == 'undefined' || (JSON.stringify(objects) !== JSON.stringify(this.prevDataViewObjects))) {
                            this.settings = {
                                //Quadrant
                                showQuadrants: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'quadrantNames', 'show', true),
                                quadrant1: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'quadrantNames', 'quadrant1', "Quadrant1"),
                                quadrant2: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'quadrantNames', 'quadrant2', "Quadrant2"),
                                quadrant3: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'quadrantNames', 'quadrant3', "Quadrant3"),
                                quadrant4: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'quadrantNames', 'quadrant4', "Quadrant4"),
                                //X-Axis and Y-Axis
                                showxAxis: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'xAxis', 'show', true),
                                showyAxis: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'yAxis', 'show', true),
                                showxAxisTitle: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'xAxis', 'titleEnable', true),
                                showyAxisTitle: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'yAxis', 'titleEnable', true),
                                showxAxisLabel: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'xAxis', 'label', true),
                                showyAxisLabel: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'yAxis', 'label', true),
                                xTitleText: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'xAxis', 'titleText', "X"),
                                yTitleText: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'yAxis', 'titleText', "Y"),
                                //Quadrant division lines
                                quadrantDivisionX: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'quadrantNames', 'quadrantDivisionX', -1),
                                quadrantDivisionY: PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.getValue(objects, 'quadrantNames', 'quadrantDivisionY', -1)
                            };
                    ...
                    ], QuadrantChart.prototype, "update", null);
                    __decorate([
                        logExceptions(), 
                        __metadata('design:type', Function), 
                        __metadata('design:paramtypes', [Object]), 
                        __metadata('design:returntype', Object)
                    ], QuadrantChart.prototype, "enumerateObjectInstances", null);
                    __decorate([
                        logExceptions(), 
                        __metadata('design:type', Function), 
                        __metadata('design:paramtypes', [Object]), 
                        __metadata('design:returntype', Boolean)
                    ], QuadrantChart.prototype, "getSettings", null);
                    return QuadrantChart;
                }());
                PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.QuadrantChart = QuadrantChart;
...
(function (powerbi) {
    ...
    (function (visuals) {
        var plugins;
        (function (plugins) {
            plugins.PBI_CV_309E6B47_39A5_4681_808F_132AFB230871_DEBUG = {
                name: 'PBI_CV_309E6B47_39A5_4681_808F_132AFB230871_DEBUG',
                displayName: 'Quadrant chart',
                class: 'QuadrantChart',
                version: '1.0.0',
                apiVersion: '1.1.0',
                create: function (options) { return new powerbi.extensibility.visual.PBI_CV_309E6B47_39A5_4681_808F_132AFB230871.QuadrantChart(options); },
                custom: true
            };
