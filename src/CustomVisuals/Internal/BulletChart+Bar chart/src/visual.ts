module powerbi.extensibility.visual {
    ...
    export class BulletBarChart implements IVisual {
        ...
        public update(options: VisualUpdateOptions) {
            ...
            if (!this.cloudChart || settingsChanged || ((options.type & VisualUpdateType.Resize) || options.type & VisualUpdateType.ResizeEnd)) {
                ...
                this.cloudChart = renderMAQVisual(dataView, this.settings, options.viewport, valueFormatter);
            }
        }
                ...
                case 'XAxis':
                    objectEnumeration.push({
                        ...
                        properties: {
                            ...
                            xAxisLabelColor: this.settings.xAxisLabelColor
                ...
                case 'YAxis':
                    objectEnumeration.push({
                        ...
                        properties: {
                            ...
                            yAxisLabelColor: this.settings.yAxisLabelColor
        ...
        private getSettings(objects: DataViewObjects): boolean {
            ...
            if (typeof this.settings == 'undefined' || (JSON.stringify(objects) !== JSON.stringify(this.prevDataViewObjects))) {
                this.settings = {
                    ...
                    xAxisLabelColor: getValue<Fill>(objects, 'XAxis', 'xAxisLabelColor', {
                        solid: {
                            color: "#000000"
                        }
                    }).solid.color,
                    ...
                    yAxisLabelColor: getValue<Fill>(objects, 'YAxis', 'yAxisLabelColor', {
                        solid: {
                            color: "#000000"
                        }
                    }).solid.color
