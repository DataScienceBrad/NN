...
module powerbi.extensibility.visual {
    ...
    export class QuadrantChart implements IVisual {
        ...
        public update(options: VisualUpdateOptions) {
            ...
            loopctr = 0;
            while (loopctr < iColLength && (dataViewObject.categories[assignData[0]].values[loopctr] === null || dataViewObject.categories[assignData[0]].values[loopctr] === "" || (typeof (dataViewObject.categories[assignData[0]].values[loopctr]) === 'number' && (dataViewObject.categories[assignData[0]].values[loopctr] >= 0)))) {
                loopctr++;
            }
            ...
            loopctr = 0;
            while (loopctr < iColLength && (dataViewObject.categories[assignData[1]].values[loopctr] === null || dataViewObject.categories[assignData[1]].values[loopctr] === "" || (typeof (dataViewObject.categories[assignData[1]].values[loopctr]) === 'number' && (dataViewObject.categories[assignData[1]].values[loopctr] >= 0)))) {
                loopctr++;
            }
            if (loopctr !== iColLength) {
                $("#container").removeAttr('style');
            ...
            //if we have radius axis, check for negative numbers, or all nulls
                ...
                loopctr = 0;
                while (loopctr < iColLength && (dataViewObject.categories[assignData[2]].values[loopctr] === "" || dataViewObject.categories[assignData[2]].values[loopctr] === null || (typeof (dataViewObject.categories[assignData[2]].values[loopctr]) === 'number' && (dataViewObject.categories[assignData[2]].values[loopctr] >= 0)))) {
                    loopctr++;
                }
                if (loopctr !== iColLength) {
                    $("#container").removeAttr('style');
            ...
            while (loopctr < length1) {
                if (dataViewObject.categories[assignData[0]].values[loopctr] === null || dataViewObject.categories[assignData[0]].values[loopctr] === "" || dataViewObject.categories[assignData[1]].values[loopctr] === null
                    || dataViewObject.categories[assignData[1]].values[loopctr] === "" || (assignData[2] !== -1 && (dataViewObject.categories[assignData[2]].values[loopctr] === null || dataViewObject.categories[assignData[2]].values[loopctr] === "")) ||
            ...
            for (jCounter = 0; jCounter < dataViewObject.categories[0].values.length; jCounter++) {
                ...
                if (assignData[3] !== -1) {
                    if (dataViewObject.categories[assignData[3]].values[jCounter] !== null && dataViewObject.categories[assignData[3]].values[jCounter] !== "") {
            ...
            if (!this.bubbleChartWithAxis || settingsChanged || ((options.type & VisualUpdateType.Resize) || options.type & VisualUpdateType.ResizeEnd)) {
                ...
                this.bubbleChartWithAxis = MAQDrawChart(this.dataView, this.settings, viewModel, series, assignData, ValueFormatter);
            }
